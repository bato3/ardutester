...
const unsigned char Version_str[] MEM_TEXT = "v1.05m";
...
/* cyrillic character set (omega and � aren't included) */
#ifdef LCD_CYRILLIC
/* omega */
...
/* unit prefixes: p, n, �, m, 0, k, M */
const unsigned char Prefix_table[] MEM_TEXT = {'p', 'n', LCD_CHAR_MICRO, 'm', 0, 'k', 'M'};
...
const uint16_t LargeCap_table[] PROGMEM = {23022, 21195, 19629, 18272, 17084, 16036, 15104, 14271, 13520, 12841, 12224, 11660, 11143, 10668, 10229, 9822, 9445, 9093, 8765, 8458, 8170, 7900, 7645, 7405, 7178, 6963, 6760, 6567, 6384, 6209, 6043, 5885, 5733, 5589, 5450, 5318, 5191, 5069, 4952, 4839, 4731, 4627, 4526, 4430, 4336};

/* voltage based factors for small caps (using Rh) */
/* voltages in mV:                        1000 1050 1100 1150 1200 1250 1300 1350 1400 */
const uint16_t SmallCap_table[] PROGMEM = {954, 903, 856, 814, 775, 740, 707, 676, 648};
...
/* prefixes with negative exponent: m, �, n, p */
