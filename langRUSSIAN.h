...
#endif
const unsigned char SetCapCorr_str[] MEM2_TEXT = {'C', '(', LCD_CHAR_U, 'F', ')', '-', Cyr_k, 'o', 'p', 'p', 'e', Cyr_k, Cyr_c, Cyr_i, Cyr_ja, 0}; // C(uF) ���४��
...
const unsigned char xtal_str[] MEM_TEXT = {Cyr_k, Cyr_v, 'a', 'p', Cyr_c, 0}; // LF �����
#endif
