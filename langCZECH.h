...
//const unsigned char Unknown[] MEM_TEXT = " neznam�"; //�";
   const unsigned char Unknown[] MEM_TEXT = {' ','n','e','z','n',Cz_a,'m',Cz_a,0}; //�";
//const unsigned char TestFailed1[] MEM_TEXT = "Zadn�, neznam�"; //��";
   const unsigned char TestFailed1[] MEM_TEXT = {Cz_Z,Cz_a,'d','n',Cz_a,' ','n','e','z','n',Cz_a,'m',Cz_a,0}; //��";
//const unsigned char OrBroken[] MEM_TEXT = "nebo vadn� "; //��";
...
//const unsigned char VOLTAGE_str[] MEM2_TEXT = "Nap�t�";
   const unsigned char VOLTAGE_str[] MEM2_TEXT = {'N','a','p',Cz_ee,'t',Cz_i,0};
//const unsigned char SHOW_str[] MEM2_TEXT = "Zobrazit �daje";	// "Show data"
...
//const unsigned char RotaryEncoder_str[] MEM2_TEXT = "rota�n� kod�r";
...
//const unsigned char TURN_str[] MEM2_TEXT = "oto�te!";
 ...
 #endif  /* WITH_MENU */
 #ifdef WITH_XTAL
//const unsigned char cerres_str[] MEM_TEXT = "Ker.rezon�tor  ";
